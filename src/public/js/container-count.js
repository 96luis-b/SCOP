            ...
            <div class="card-body">
                ...
                <div class="container">
                    <div class="row text-center mt-3">
                        <div class="col-1">
                            <button class="btn btn-info btn-custon" name="remove" onclick="scan_click_button(this)">-</button>
                        </div>
                        <div class="col-3"></div>
                        <div class="col-2">
                            <button class="btn btn-info btn-custon" name="" onclick="scan_click_button(this)">-1/2</button>
                        </div>
                        <div class="col-2">
                            <button class="btn btn-info btn-custon" name="" onclick="scan_click_button(this)">+1/2</button>
                        </div>
                        <div class="col-3"></div>
                        <div class="col-1">
                            <button class="btn btn-info btn-custon" name="add" onclick="scan_click_button(this)">+</button>
                        </div>
                    </div>  
                </div>
            </div>
